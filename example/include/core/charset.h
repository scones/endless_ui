...
namespace core {
  ...
  class charset {
    ...
    void render_text(std::string const& text, float x, float y, core::t_vec2ui32 resolution);
    void render_text_ortho(std::string const& text, std::uint32_t x, std::uint32_t y, core::t_vec2ui32 resolution, std::uint32_t alignment = charset::ALIGNMENT::LEFT);
